...
/**
 * Переопределенный класс AsynchronousHttpClientFactory.
...
public class CustomAsynchronousHttpClientFactory extends AsynchronousHttpClientFactory {
    ...
    public DisposableHttpClient createClientCustom(final URI serverUri, final AuthenticationHandler authenticationHandler, int socketTimeoutInSec) {
